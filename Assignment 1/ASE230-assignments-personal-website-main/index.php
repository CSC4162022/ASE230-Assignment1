...
const nameCory = "Cory DuCharme";
const designationCory = "Founder & CEO";
const nameNazrul = "Nazrul Islam";
const designationNazrul = "UI Designer";
const nameRiyadh = "Riyadh Khan";
const designationRiyadh = "Developer";
const nameNiloy = "Niloy Islam";
const designationNiloy = "Marketing Manager";
?>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                ...
                <div class="single_advisor_details_info">
                    <h6><?= nameCory ?></h6>
                    <p class="designation"><?=designationCory?> </p>
                </div>
                </div>
            </div>
            <!-- Single Advisor-->
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    ...
                    <div class="single_advisor_details_info">
                        <h6><?= nameNazrul ?></h6>
                        <p class="designation"><?=  designationNazrul?> </p>
                    </div>
                </div>
            </div>
            <!-- Single Advisor-->
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                    ...
                    <div class="single_advisor_details_info">
                        <h6><?= nameRiyadh ?></h6>
                        <p class="designation"><?=designationRiyadh?> </p>
                    </div>
                </div>
            </div>
            <!-- Single Advisor-->
            <div class="col-12 col-sm-6 col-lg-3">
                ...
                <div class="single_advisor_details_info">
                    <h6><?= nameNiloy ?></h6>
                    <p class="designation"><?=designationNiloy?> </p>
                </div>
                </div>
            </div>
        </div>
