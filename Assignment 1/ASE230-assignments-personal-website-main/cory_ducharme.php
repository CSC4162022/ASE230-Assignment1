<html lang="en">
	...
	<body>
        ...
        <title><?php echo "ASE 230 - Cory DuCharme"; ?></title>
        <div class="container text-center mb-5">
            <h1><?= 'This is ASE 230' ?></h1>
            <h6><?='Cory DuCharme'?> </h6>
        ...
        <div class="row">
          <div class="col-lg-5 col-md-6">
            ...
            <div class="mb-2 d-flex">
              <h4 class="font-weight-normal"><?php echo "Cory DuCharme"; ?></h4>
          ...
          <div class="col-lg-7 col-md-6 pl-xl-3">
              <p><?='Some information about me here'?></p>
          </div>
        </div>
      </div>
